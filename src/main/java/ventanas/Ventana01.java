...
public class Ventana01 extends JFrame {
    ...
    public void iniciarPaneles(){
     this.jPanelList= new ArrayList<>();
        ...
        this.jPanelList.get(5).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(6).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(7).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(8).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(9).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(10).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(11).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(12).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(13).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(14).setBackground(Color.DARK_GRAY);  
        this.jPanelList.get(15).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(16).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(17).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(18).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(19).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(20).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(21).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(22).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(23).setBackground(Color.DARK_GRAY);
        this.jPanelList.get(24).setBackground(Color.DARK_GRAY);
